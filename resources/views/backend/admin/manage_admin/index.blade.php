...
@section('admin')
    ...
    <div class="page-content">
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <a href="{{ route('add.admin') }}" class="btn btn-inverse-info">Add New Admin</a></a>
            </ol>
        </nav>
                                ...
                                <tbody>
                                    @foreach ($data as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <img
                                                    src="{{ !empty($row->photo) ? url('upload/images/admin/' . $row->photo) : url('upload/images/no_image.jpg') }}">
                                            </td>
                                            <td>{{ $row->name }}</td>
                                            <td>{{ $row->email }}</td>
                                            <td>{{ $row->phone }}</td>
