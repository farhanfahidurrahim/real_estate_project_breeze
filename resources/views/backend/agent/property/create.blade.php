                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="property_status" value="{{ old('property_status') }}"
                                            ...
                                            <option value="rent" {{ old('property_status') == 'rent' ? 'selected' : '' }}>
                                                rent</option>
                                            <option value="buy" {{ old('property_status') == 'buy' ? 'selected' : '' }}>
                                                buy</option>
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="maximum_price" value="{{ old('maximum_price') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="property_video" value="{{ old('property_video') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="amenities_id[]"
                                            ...
                                            @foreach ($amenities as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ in_array($row->id, old('amenities_id', [])) ? 'selected' : '' }}>
