    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>FahidurRahim</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
               Real Estate Head Office
               Email:support@fahidur.com <br>
               Mob: 01675717825 <br>
               Dhaka, Uttara<br>
            </pre>
            </td>
        ...
        <tr>
            <td>
                <p class="font" style="margin-left: 20px;">
                    ...
                    <strong>Email:</strong> {{ $packageHistory->user->name }} <br>
            ...
            <td>
                <p class="font">
                <h3><span style="color: green;">Invoice:</span> #{{ $packageHistory->package_invoice }}</h3>
                Order Date: {{ $packageHistory->created_at->format('l d M Y') }} <br>
                Payment Type : COD
                </p>
            </td>
        </tr>
